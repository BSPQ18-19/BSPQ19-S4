...
public interface IServer extends Remote {
	 ...
	 * 
	 * @param fAlq
	 *            Fecha en la que se alquila la pelicula
	 * @param tAlq
	 *            Tiempo durante el que se alquila la pelicula
	 * @param nombre
	 *            Nomrbre del la persona que alquila
	 * @param titulo
	 ...
	 * 
	 * @param admin
	 *            Nombre de la cuenta a comprobar
	 * @return
	 * @throws RemoteException
	 */
	 ...
	 * 
	 * @param nombre
	 *            Nombre para verificar la contraseña
	 * @return
	 * @throws RemoteException
	 */
	 ...
	 * 
	 * @param titulo
	 *            Titulo de la pelicual a buscar
	 * @return
	 * @throws RemoteException
	 */
